...
public class DataCiteMetadataTest {
  ...
  public static DataCiteMetadata getMockMetadata(DOI doi, String title) {
    return DataCiteMetadata.builder()
        ...
        .withTitles(
            Titles.builder()
                .addTitle(Title.builder().withLang("en-us").withValue(title).build())
                .addTitle(
                    Title.builder()
                        .withLang("en-us")
        ...
        // build publisher
        .withPublisher(Publisher.builder().withValue("DataCite").build())
            ...
            RelatedIdentifiers.builder()
                .addRelatedIdentifier(
                    RelatedIdentifier.builder()
                        ...
                        .withValue(
                            "http://data.datacite.org/application/citeproc+json/10.21373/example-full")
                        .build())
                .addRelatedIdentifier(
                    RelatedIdentifier.builder()
        ...
        .withDates(
            Dates.builder()
                .addDate(
                    Date.builder().withDateType(DateType.UPDATED).withValue("2014-10-17").build())
                .build())
        ...
        .withCreators(
            Creators.builder()
                .addCreator(
                    Creator.builder()
                        .withCreatorName(
                            CreatorName.builder().withValue("Miller, Elizabeth").build())
                        .addNameIdentifier(
                            NameIdentifier.builder()
                                ...
                                .build())
                        .addAffiliation(Affiliation.builder().withValue("DataCite").build())
                        .build())
                .build())

        // build identifier
        .withIdentifier(
            Identifier.builder().withIdentifierType("DOI").withValue(doi.getDoiName()).build())
            ...
            AlternateIdentifiers.builder()
                .addAlternateIdentifier(
                    AlternateIdentifier.builder()
                        ...
                        .withValue(
                            "http://schema.datacite.org/schema/meta/kernel-4/example/datacite-example-full-v4.xml")
                        .build())
                .build())
        ...
        // build sizes
        .withSizes(Sizes.builder().addSize("3KB").build())

        // build formats
        .withFormats(Formats.builder().addFormat("application/xml").build())
            ...
            Contributors.builder()
                .addContributor(
                    Contributor.builder()
                        ...
                        .withContributorName(
                            ContributorName.builder().withValue("Starr, Joan").build())
                        .withNameIdentifier(
                            NameIdentifier.builder()
                                .withSchemeURI("http://orcid.org/")
                                .withNameIdentifierScheme("ORCID")
                                ...
                                .build())
                        .withAffiliation(
                            Affiliation.builder().withValue("California Digital Library").build())
                        .build())
                .build())
